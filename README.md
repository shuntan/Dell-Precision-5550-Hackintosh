# Dell Precision 5550 with macOS Big Sur
...
This is more of a compilation of information and configs from various repositories and forums than a place where real development happens. This repository should contain everything needed to get Big Sur up and running on your Dell Precision 5550 laptop.
...
| **Internal Display**          | 3840x2400@60Hz                           | ✅ Working     | Internal eDP display fully working including Backlight control. |
...
| **Trackpad**                  | I2C ALPS ???? (Named Dell097E) ping 0x33 | 🔶 Partially   | Working with full gesture support (5 fingers) but the hardware buttons are not working. You can use left/right click with touch tap (change in settings). |
| **Wi-Fi/ BT**                 | Intel Wi-Fi 6 AX201 160MHz               | ✅ Working     | The stock Intel AX Wi-Fi 6 card needs to be swapped out to a compatible card. |
...
<img src="img/DCIM.jpg" width="200px" />
